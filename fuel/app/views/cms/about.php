    ...
    <div class="container_12">
        <div class="wrapper p5">
            <article class="grid_4">
                <div class="wrapper">
                    <figure class="img-indent"><img src="<?php echo Asset::get_file('theme-car/page1-img1.png', 'img')?>" alt=""></figure>
            ...
            <article class="grid_4">
                <div class="wrapper">
                    <figure class="img-indent"><img src="<?php echo Asset::get_file('theme-car/page1-img2.png', 'img')?>" alt=""></figure>
                    <div class="extra-wrap">
            ...
            <article class="grid_4">
                <div class="wrapper">
                    <figure class="img-indent"><img src="<?php echo Asset::get_file('theme-car/page1-img3.png', 'img')?>" alt=""></figure>
                    <div class="extra-wrap">
                        ...
                        <article class="grid_8">
                            <div class="indent-left">
                                <div class="wrapper border-bot2">
                                    <figure class="img-indent2"><img src="<?php echo Asset::get_file('theme-car/page2-img1.png', 'img')?>" alt=""></figure>
                                    <div class="extra-wrap">
                                ...
                                <div class="wrapper img-indent-bot">
                                    <figure class="img-indent3"><img src="<?php echo Asset::get_file('theme-car/page2-img2.png', 'img')?>" alt=""></figure>
                                    <div class="extra-wrap">
                                ...
                                <div class="wrapper">
                                    <div class="col-1">
                                        <figure class="indent-bot"><a href="#"><img src="<?php echo Asset::get_file('theme-car/page2-img3.png', 'img')?>" alt=""></a></figure>
                                    ...
                                    <div class="col-1">
                                        <figure class="indent-bot"><a href="#"><img src="<?php echo Asset::get_file('theme-car/page2-img4.png', 'img')?>" alt=""></a></figure>
                                        <h6><strong>William Torn</strong></h6>
                                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.
                                    </div>
                                    <div class="col-2">
                                        <figure class="indent-bot"><a href="#"><img src="<?php echo Asset::get_file('theme-car/page2-img5.png', 'img')?>" alt=""></a></figure>
                        ...
                        <article class="grid_4">
                            <div class="indent-left2 indent-top">
                                <div class="box indent-bot">
                                    <div class="padding">
                                        <div class="wrapper">
                                            <figure class="img-indent"><img src="<?php echo Asset::get_file('theme-car/page1-img4.png', 'img')?>" alt=""></figure>
                                            <div class="extra-wrap">
